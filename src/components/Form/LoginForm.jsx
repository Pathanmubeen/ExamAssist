...
function LoginForm({ loading, handleGoogleLogin }) {
  return (
    <>
      <Form
      ...
      >
        ...
        <button
          ...
          className={`flex rounded-full ${!loading
              ? "bg-orange-500 hover:bg-neutral-50 hover:text-orange-500"
              : "bg-orange-500/70 cursor-not-allowed"
            } p-1 justify-center items-center font-semibold md:font-bold text-xs md:text-sm text-center mb-3 transition text-white`}
        >
          <AiOutlineGoogle className="mr-2 text-lg" /> {/* Google Icon */}
